...
parser.add_argument("--cuda", action="store_true",
                    help="use cuda?")
parser.add_argument("--model", default="model/model_epoch_50.pth", type=str,
                    help="model path")
...
parser.add_argument("--path", default="../dataset/testing_lr_images/",
...
for img in img_list:
    ...
    im_b_ycbcr = scipy.misc.imresize(im_b_ycbcr,
    ...
    im_input = im_input.view(1, -1, im_input.shape[0], im_input.shape[1])
